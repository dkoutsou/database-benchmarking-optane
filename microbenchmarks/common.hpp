 ...
 * 64-byte benchmarks
 */
inline uint64_t store_64byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
...
inline uint64_t store_64byte_clflush(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
...
inline uint64_t store_64byte_clwb(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t store_64byte_clflushopt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t nstore_64byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    /*
...
inline uint64_t load_64byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
...
inline uint64_t load_64byte_fence_nt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    /*
     * Requires avx2
...
inline uint64_t baseline(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
...
inline uint64_t store_64byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t store_64byte_clflush_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t load_64byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
 ...
 * 128-byte benchmarks
 */
inline uint64_t store_128byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_VALUE
...
inline uint64_t store_128byte_clflush(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t store_128byte_clwb(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t store_128byte_clflushopt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t nstore_128byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t load_128byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
...
inline uint64_t load_128byte_fence_nt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
...
inline uint64_t store_128byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t store_128byte_clflush_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t load_128byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
 ...
 * 256-byte benchmarks
 */
inline uint64_t store_256byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_VALUE
...
inline uint64_t store_256byte_clflush(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t store_256byte_clwb(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t store_256byte_clflushopt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t nstore_256byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
...
inline uint64_t load_256byte_fence(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
...
inline uint64_t load_256byte_fence_nt(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
...
inline uint64_t store_256byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t store_256byte_clflush_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        LOAD_CACHE_LINE
...
inline uint64_t load_256byte_fence_movq(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    KERNEL_BEGIN
    asm volatile(LOAD_ADDR
        FLUSH_CACHE_LINE
 ...
 * 256-byte benchmarks
 */
inline uint64_t repeat_256byte_ntstore(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_VALUE
 ...
 * 256-byte benchmarks
 */
inline uint64_t repeat_256byte_load(char *addr) {
    uint64_t t1 = 0, t2 = 0;
    uint64_t value = 0xC0FFEEEEBABE0000;
    KERNEL_BEGIN
    asm volatile(LOAD_VALUE
